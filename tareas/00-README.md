...
| ⚠️ | Máquina de estados sobre-modelada (sobran PAUSADA, CANCELADA, PENDIENTE, EN_CONFIG, CONFIGURADA) |
| ⚠️ | Falta eje "fase de mantenimiento" paralelo al estado |
...
- [01 — Alinear estados y fase de mantenimiento](01-alinear-estados-y-fase.md)
